...
<form action="<?= base_url('/user/ssh/ssh_pengajuan/ssh_update') ?>" method="POST">
	<div class="card-body">
			...
			<div class="col-md-10">
				<div class="input-group">
					<select name="sub_rincian_objek" id="sub_rincian_objek_id" class="form-control select2bs4 <?= ($validation->hasError('sub_rincian_objek')) ? 'is-invalid' : ''; ?>" required>
						<option value="<?= $ssh['id_jenis_rincian_objek_sub']; ?>"><?= '[' . $ssh['kode_jenis_rincian_objek_sub'] . '] ' . $ssh['jenis_rincian_objek_sub']; ?></option>
					</select>
					<div class="invalid-feedback">
		...
		<div class="row">
			...
			<div class="col-md-10">
				<div class="input-group">
					<input type="text" name="komponen" value="<?= $ssh['komponen']; ?>" class="form-control" maxlength="300" require>
				</div>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-md-10">
				<div class="input-group">
					<textarea name="spesifikasi" class="form-control" maxlength="500" rows="3" require> <?= $ssh['spesifikasi']; ?></textarea>
				</div>
			</div>
		</div><br>
		<div class="row">
			...
			<div class="col-md-10">
				<div class="input-group">
					<input type="text" name="satuan" value="<?= $ssh['satuan']; ?>" class="form-control" maxlength="50" require>
				</div>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-md-10">
				<div class="input-group">
					<input type="number" name="harga" value="<?= $ssh['harga']; ?>" class="form-control" maxlength="20" require>
				</div>
			</div>
		</div>
		<div class="row">
