...
<form action="<?= base_url('/user/ssh/hspk/hspk_create') ?>" method="POST">
	<div class="card-body">
		<?= csrf_field() ?>
		<div class="row">
			<div class="col-md-2">
...
<script>
	...
	$(document).ready(function() {
		$('#akun_id').change(function() {
			var id = $(this).val();
			$.ajax({
				url: "<?php echo base_url('user/ssh/hspk/ambilkelompok'); ?>",
				method: "POST",
				data: {
					id: id
				},
		...
		$('#kelompok_id').change(function() {
			var id = $(this).val();
			$.ajax({
				url: "<?php echo base_url('user/ssh/hspk/ambiljenis'); ?>",
				method: "POST",
				data: {
					id: id
				},
		...
		$('#jenis_id').change(function() {
			var id = $(this).val();
			$.ajax({
				url: "<?php echo base_url('user/ssh/hspk/ambilobjek'); ?>",
				method: "POST",
				data: {
					id: id
				},
		...
		$('#objek_id').change(function() {
			var id = $(this).val();
			$.ajax({
				url: "<?php echo base_url('user/ssh/hspk/ambilrincianobjek'); ?>",
				method: "POST",
				data: {
					id: id
				},
		...
		$('#rincian_objek_id').change(function() {
			var id = $(this).val();
			$.ajax({
				url: "<?php echo base_url('user/ssh/hspk/ambilsubrincianobjek'); ?>",
				method: "POST",
				data: {
					id: id
				},
