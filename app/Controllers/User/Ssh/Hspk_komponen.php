...
use App\Models\User\Ssh\Model_hspk_komponen;
	...
	public function data($id)
	{
		if (has_permission('User')) :
			...
			$data = [
				'gr' => 'hspk',
				'mn' => 'hspk',
				'lok' => '<a href="/user/ssh/hspk">HSPK</a> -> <b>HSPK Komponen</b>',
				'A' => $A,
				'B' => $B,
				'C' => $C,
				'hspk1' => $hspk1,
			...
			echo view('user/Ssh/hspk_komponen', $data);
		else :
	...
	public function data_add($id)
	{
		if (has_permission('User')) :
			...
			$data = [
				'gr' => 'hspk',
				'mn' => 'hspk',
				'lok' => 'HSPK -> <a href="/user/ssh/hspk_komponen/data/' . $id . '">HSPK Komponen</a> -> <b>Tambah HSPK Komponen</b>',
				// 'ssh' => $ssh,
				'id_hspk' => $id,
			];
			echo view('user/Ssh/hspk_komponen_add', $data);
		else :
			throw \CodeIgniter\Exceptions\PageNotFoundException::forPageNotFound();
		endif;
	}
	...
	public function data_edit($id, $id_hspk)
	{
		if (has_permission('User')) :
			...
			$data = [
				'gr' => 'hspk',
				'mn' => 'hspk',
				'lok' => 'HSPK -> <a href="/user/ssh/hspk_komponen/data/' . $id_hspk . '">HSPK Komponen</a> -> <b>Ubah HSPK Komponen</b>',
				'data' => $data,
				'id_hspk' => $id_hspk,
			];
			echo view('user/Ssh/hspk_komponen_edit', $data);
		else :
			throw \CodeIgniter\Exceptions\PageNotFoundException::forPageNotFound();
		endif;
	}
